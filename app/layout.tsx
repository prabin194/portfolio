      ...
      <body className={geist.className}>
        <ThemeProvider>
          ...
          <div className="min-h-screen bg-background text-foreground">
            <Header />
            <main id="main-content" className="mx-auto max-w-6xl px-6 py-12 xl:px-8">{children}</main>
            <footer className="border-t border-border">
              <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-6 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between xl:px-8">
